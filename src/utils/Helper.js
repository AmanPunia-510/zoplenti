...
export const TIMELINE_DATA = [
  ...
  },
  {
    ...
    Paragraph:
      "ZVP enables in-depth analysis of your market, product listings, and competitors. By analyzing over a hundred factors, we identify high-impact growth initiatives to enhance your market share, which our marketing team then implements as an extension of yours.",
  ...
  },
  {
    ...
    Paragraph:
      "We use ZVP to generate detailed monthly reports for our partners, featuring essential sales and marketing statistics. These reports provide clear insights into our performance on Amazon, ensuring transparency with concrete data rather than vague promises.",
  ...
  },
  {
    ...
    Paragraph:
      "ZVP actively monitors pricing for each SKU we sell, alerting us to any MAP violations. This ensures we can promptly inform our partners of any violations and assist in identifying the source of the issue.",
    arrow: <Icon icons="arrow" />,
    icon: <Icon icons="map" />,
  },
  {
    ...
    Paragraph:
      "We use ZVP to track stock levels for every SKU in real time, enabling us to forecast demand and strategically plan our next order. This ensures timely reorders, preventing stockouts and maximizing our business together.",
    arrow: <Icon icons="arrow" />,
  ...
  },
  {
    ...
    Paragraph:
      "ZVP manages all Zoplenti operations, including our vendors and purchase orders, ensuring the day to day of our business runs smoothly. This helps reduce logistical and communication issues with our partners, and makes it easy to work with us.",
    arrow: <Icon icons="arrow" />,
