...
export const CORE_VALUE_DATA = [
  {
    coreSvg: <Icon icon="handShake" />,
    title: "Relationships Beyond Business",
  },
  {
    coreSvg: <Icon icon="result" />,
    title: "Results Over Promises",
  },
  {
    coreSvg: <Icon icon="possible" />,
    title: "Anything Is Possible",
  },
  {
    coreSvg: <Icon icon="like" />,
    title: "Get 1% Better Daily",
  },
  {
    coreSvg: <Icon icon="payment" />,
    title: "Pay It Forward ",
  },
];

export const TOP_SELLER_DATA = [
  {
    image: <Icon icon="group" />,
    title: "Top Amazon Seller",
    description:
      "We proudly rank among the top 0.01% of Amazon sellers, maintain a flawless 100% positive rating from customers, with well over 1 million orders fulfilled. ",
  },
  {
    image: <Icon icon="inc" />,
    title: "Inc. 5000",
    description:
      "We were recognized as one of Inc.’s 5000 fastest growing companies, and we’re committed to working hard to sustain that growth.",
  },
  {
    image: <Icon icon="document" />,
    title: "Active since 2016",
    description:
      "We are a family-run business, active since 2016 and headquartered in Tampa, Florida.",
  },
];
